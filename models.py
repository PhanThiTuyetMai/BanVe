...
# class Chi_Tiet_Ve_Xe(BaseModel):
#     Ma_Ve = models.ForeignKey(Ve_Xe, on_delete=models.CASCADE, null=True);
#     Ma_Xe = models.ForeignKey(Xe, on_delete=models.PROTECT)
#     Vi_tri_ghe_ngoi = models.ForeignKey(Ghe, on_delete=models.PROTECT, null=True)
#     Ghichu = models.CharField(max_length=255)
