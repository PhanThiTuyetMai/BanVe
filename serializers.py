...
from .models import (NhanVien, KhachHang, TaiXe,
                     TuyenXe, ChuyenXe, Ve_Xe, Chi_Tiet_Ve_Xe, User, Comment, Ghe, Xe, Khach_di)
...
class ThemNhanVienSerializer(ItemSerializer):
    class Meta:
        ...
        fields = ['Ten_NV', 'NgaySinh', 'GioiTinh', 'DiaChi', 'CMND',
                  'DienThoai', 'Email', 'avatar'] # Hoặc chỉ định các trường cụ thể bạn muốn bao gồm
        extra_kwargs = {
            'id': {'required': False}  # Trường ID không bắt buộc
        }
